...
def distance_between_points(a_radial_dis, a_polar_ang, a_azimuthal_ang, b_radial_dis, b_polar_ang, b_azimuthal_ang):
    ...
    sin_eq = (math.sin(a_polar_ang) * math.sin(b_polar_ang) * math.cos(a_azimuthal_ang - b_azimuthal_ang) +
                math.cos(a_polar_ang) * math.cos(b_polar_ang))
    final = math.sqrt(a_radial_dis ** 2 + b_radial_dis ** 2 - (2 * a_radial_dis * b_radial_dis * sin_eq))
